    ...
    describe("WHEN trying to deploy TraderWallet contract with correct parameters", function () {
      ...
      describe("WHEN trying to deploy TraderWallet contract with correct parameters", function () {
        ...
        it("THEN ==> CLAIMING SHARES 3", async () => {
          ...
          await usersVaultContract
            .connect(user1)
            .claimShares(AMOUNT_1E18.mul(10), user1Address);
          await usersVaultContract
            .connect(user2)
            .claimShares(AMOUNT_1E18.mul(20), user2Address);
          await showStructsAndVariables();
          // await showPreview();
          await showBalances();
          console.log(
        ...
        it("THEN ==> CLAIM ASSETS 6", async () => {
          ...
          await usersVaultContract
            .connect(user1)
            .claimAssets(AMOUNT_1E18.mul(2), user1Address);
          await usersVaultContract
            .connect(user2)
        ...
        it("THEN ==> CLAIMING SHARES 8", async () => {
          ...
          await usersVaultContract
            .connect(user1)
            .claimShares(AMOUNT_1E18.mul(20), user1Address);
          await usersVaultContract
            .connect(user2)
            .claimShares(AMOUNT_1E18.mul(40), user2Address);
          await showStructsAndVariables();
          await showPreview();
          await showBalances();
          console.log(
